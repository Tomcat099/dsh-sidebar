 ...
 */
export function scopedDocumentPath(profileDir: string, projectRoot?: string): string {
 ...
 */
function ensureProfileDir(profileDir: string, name: string): string {
 ...
 */
export function scratchDir(profileDir: string): string {
 ...
 */
export function cacheDir(profileDir: string): string {
 ...
 */
export function snapshotDir(profileDir: string): string {
